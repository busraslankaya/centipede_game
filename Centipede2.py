...
class Centipede2(pygame.sprite.Sprite):
    gifDelay = 0
    gifCounter = 0
    gif = []
    ...
    def __init__(self, x, y):
        ...
        self.imgSize = (20, 20)
        self.image = pygame.image.load(os.path.join("images", "lvl2_centi1.png"))
        self.gif.append(pygame.image.load(os.path.join("images", "lvl2_centi1.png")))
        self.gif.append(pygame.image.load(os.path.join("images", "lvl2_centi2.png")))
