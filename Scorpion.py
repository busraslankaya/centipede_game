...
class Scorpion(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load(os.path.join("images", "scorpion1.png"))
        self.gif.append(pygame.image.load(os.path.join("images", "scorpion1.png")))
        self.gif.append(pygame.image.load(os.path.join("images", "scorpion2.png")))
